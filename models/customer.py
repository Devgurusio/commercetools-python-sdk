...
class Customer(BaseModel):
  ...
  def change_password(self, current_password: str, new_password: str, force = False):
    self.__dict__.update(self._repository.change_password(current_password=current_password, new_password=new_password, obj=self, force=force).__dict__)
    return self
  ...
  def save(self, force = False):
    if self.id == None:
      ...
      self.__dict__.update(self._repository.update(self, force=force).__dict__)
    return self  
